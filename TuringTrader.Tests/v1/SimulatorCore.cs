...
namespace SimulatorEngine.Tests
{
    ...
    public class SimulatorCore
    {
        ...
        private class Test_Trade_Simulator : TuringTrader.Simulator.Algorithm
        {
            ...
            {
                Bar.NewOHLC("SPX", DateTime.Parse("1/02/2019, 4pm"), 2476.96, 2519.49, 2467.47, 2510.03, 2257700000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/03/2019, 4pm"), 2491.92, 2493.14, 2443.96, 2447.89, 2782400000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/04/2019, 4pm"), 2474.33, 2538.07, 2474.33, 2531.94, 2682000000),
                //---
                Bar.NewOHLC("SPX", DateTime.Parse("1/07/2019, 4pm"), 2535.61, 2566.16, 2524.56, 2549.69, 2553900000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/08/2019, 4pm"), 2568.11, 2579.82, 2547.56, 2574.41, 2497200000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/09/2019, 4pm"), 2580.00, 2595.32, 2568.89, 2584.96, 2485100000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/10/2019, 4pm"), 2573.51, 2597.82, 2562.02, 2596.64, 2346300000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/11/2019, 4pm"), 2588.11, 2596.27, 2577.40, 2596.26, 2075200000),
                //---
                Bar.NewOHLC("SPX", DateTime.Parse("1/14/2019, 4pm"), 2580.31, 2589.32, 2570.41, 2582.61, 2264300000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/15/2019, 4pm"), 2585.10, 2613.08, 2585.10, 2610.30, 2316500000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/16/2019, 4pm"), 2614.75, 2625.76, 2612.68, 2616.10, 2439000000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/17/2019, 4pm"), 2609.28, 2645.06, 2606.36, 2635.96, 2480500000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/18/2019, 4pm"), 2651.27, 2675.47, 2647.58, 2670.71, 2634600000),
                //---
                Bar.NewOHLC("SPX", DateTime.Parse("1/22/2019, 4pm"), 2657.88, 2657.88, 2617.27, 2632.90, 2614600000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/23/2019, 4pm"), 2643.48, 2653.19, 2612.86, 2638.70, 2269000000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/24/2019, 4pm"), 2638.84, 2647.20, 2627.01, 2642.33, 2462500000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/25/2019, 4pm"), 2657.44, 2672.38, 2657.33, 2664.76, 2537100000),
                //---
                Bar.NewOHLC("SPX", DateTime.Parse("1/28/2019, 4pm"), 2644.97, 2644.97, 2624.06, 2643.85, 2326800000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/29/2019, 4pm"), 2644.89, 2650.93, 2631.05, 2640.00, 2183700000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/30/2019, 4pm"), 2653.62, 2690.44, 2648.34, 2681.05, 2576400000),
                Bar.NewOHLC("SPX", DateTime.Parse("1/31/2019, 4pm"), 2685.49, 2708.95, 2678.65, 2704.10, 3423600000),
            };
            ...
            public override void Run()
            {
                ...
                foreach (var s in SimTimes)
                {
                    ...
                    if (SimTime[0].Date == DateTime.Parse("01/02/2019"))
                    {
                    ...
                    if (SimTime[0].Date == DateTime.Parse("01/03/2019"))
                    {
                    ...
                    //===== stop order, next bar
                    if (SimTime[0].Date == DateTime.Parse("01/04/2019"))
                    {
                    ...
                    if (SimTime[0].Date == DateTime.Parse("01/07/2019"))
                    {
