...
namespace TuringTrader.SimulatorV2.Tests
{
    ...
    public class T305_Volatility
    {
        ...
        private class Testbed_TrueRange_V2vsV1 : Algorithm
        {
            ...
            public override void Run()
            {
                ...
                v2Result = Asset("$SPX").TrueRange().Data;
            }
        }

        [TestMethod]
        public void Test_TrueRange_V2vsV1()
        {
            var algo = new Testbed_TrueRange_V2vsV1();
            algo.Run();
